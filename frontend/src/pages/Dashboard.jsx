      ...
      <main className="mx-auto max-w-6xl px-6 py-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#f6682f] px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-[#ea580c]"
            ...
            loading || !stats ? (
              ...
              <>
                ...
                <StatCard
                  ...
                  value={
                    stats.page_views?.toLocaleString("fr-FR") ?? 0
                  }
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3 text-stone-500">
                        ...
                        {
                          event.views_count?.toLocaleString(
                            "fr-FR"
                          ) ?? 0
                        }
                      ...
                      <td className="px-5 py-3">
                        ...
                        <div className="flex gap-1">
                          ...
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/create-event?edit=${event.id}`
                              )
                            }

                            className="rounded p-1.5 text-stone-500 transition-colors hover:bg-[#f6682f]/10"
            ...
            !loading && (
              ...
              <div className="flex items-center justify-between border-t border-stone-100 px-5 py-3 text-xs text-stone-400">
                ...
                <span>
                  ...
                  Affichage de {visibleEvents.length} sur{" "}
